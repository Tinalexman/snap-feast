...
class FileManager {
  static Future<void> saveAuthDetails(Map<String, String>? auth) async {
    ...
    await instance.setString(
        "snapfeast_user_email", auth == null ? "" : auth["emailAddress"]!);
    await instance.setString(
        "snapfeast_user_password", auth == null ? "" : auth["password"]!);
  }

  static Future<Map<String, String>?> loadAuthDetails() async {
    SharedPreferences instance = await SharedPreferences.getInstance();
    String? email = instance.getString("snapfeast_user_email");
    String? password = instance.getString("snapfeast_user_password");
